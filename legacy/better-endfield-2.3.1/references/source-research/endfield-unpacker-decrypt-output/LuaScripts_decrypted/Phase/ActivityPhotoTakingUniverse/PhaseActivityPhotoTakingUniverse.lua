...
PhaseActivityPhotoTakingUniverse.s_messages = HL.StaticField(HL.Table) << {
...
PhaseActivityPhotoTakingUniverse.PrepareTransition = HL.Override(HL.Number, HL.Boolean, HL.Opt(HL.Number)) << function(self, transitionType, fastMode, anotherPhaseId)
...
HL.Commit(PhaseActivityPhotoTakingUniverse)
